...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var BaseElement = class extends s3 {
  };
  ...
  var KdPhoneHero = class KdPhoneHero2 extends BaseElement {
    static {
      this.styles = i`
    :host {
  ...
  var KdLifeEvent = class KdLifeEvent2 extends BaseElement {
    constructor() {
      super(...arguments);
      this.type = "other";
    }
    ...
    render() {
      return x`
      ${this.asset ? x`<img class="icon" src="${this.asset}" alt="" />` : T}
  ...
  __decorate2([
    n4({ type: String, attribute: "start-date" })
  ], KdLifeEvent.prototype, "startDate", void 0);
  KdLifeEvent = __decorate2([
    t3("kd-life-event")
  ], KdLifeEvent);
  ...
  var KdLifeEvents = class KdLifeEvents2 extends BaseElement {
    render() {
      return x`<slot></slot>`;
    }
  };
  KdLifeEvents = __decorate3([
    t3("kd-life-events")
  ], KdLifeEvents);
})();
