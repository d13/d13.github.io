...
`;var g=class extends H(s){render(){return a`<a
      class="button"
      part="base"
      href="${R(this.href)}"
      ...
      rel="${R(this.rel)}"
      ><slot></slot
    ></a>`}};g.styles=[A],i([M(".button",!0)],g.prototype,"_control",2),i([o()],g.prototype,"href",2),i([o()],g.prototype,"target",2),i([o()],g.prototype,"rel",2),g=i([d("kd-link-button")],g);var v=class extends s{updated(){this.src&&this.style.setProperty("--kd-phone-hero-background-image",`url(${this.src})`)}render(){return a`<div class="container"><slot class="content"></slot></div>`}};v.styles=n`
    *,
    *::before,
    *::after {
      box-sizing: border-box;
  ...
  `,i([o({type:String})],v.prototype,"src",2),v=i([d("kd-phone-hero")],v);var B=new Map;function le(l){let r=B.get(l);return r||(r=new Intl.DateTimeFormat(void 0,l),B.set(l,r)),r}var re=Object.freeze({year:"numeric",month:"long"});function X(l,r=re){return le(r).format(l)}var il=Object.freeze({numeric:"auto"});var I=1e3,O=I*60,C=O*60,E=C*24,Y=E*7,Z=E*30,$=E*365,W=$*4,tl=Object.freeze(new Map([["year",$],["years",$],["quarter",W],["quarters",W],["month",Z],["months",Z],["week",Y],["weeks",Y],["day",E],["days",E],["hour",C],["hours",C],["minute",O],["minutes",O],["second",I],["seconds",I]]));var al=Object.freeze({localeMatcher:"best fit",numeric:"always",style:"narrow"});var u=class extends s{constructor(){super(...arguments);this.type="event";this.assetType="image"}get endingDate(){if(this.date==="present")return u.now;let e=new Date(this.date);if(e.toString()!=="Invalid Date")return e}get startingDate(){if(this.startDate===void 0)return;let e=new Date(this.startDate);if(e.toString()!=="Invalid Date")return e}renderDateTime(e){if(e===void 0)return;if(e==="present")return a`<time datetime="${u.now.getFullYear()}">Present</time>`;if(e.length===4)return a`<time datetime="${e}">${e}</time>`;let t=new Date(e);if(t.toString()!=="Invalid Date")return a`<time datetime="${t.toISOString()}">${X(t)}</time>`}renderDateRange(){if(this.date===this.startDate)return this.renderDateTime(this.date);let e=[],t=this.renderDateTime(this.startDate);t!==void 0&&e.push(t);let c=this.renderDateTime(this.date);if(c!==void 0&&e.push(c),e.length===0)return z;let[p,f]=e;return f===void 0?p:a`<div class="date-range">${p} <span aria-label="to">-</span> ${f}</div>`}renderMedia(){return this.asset===void 0?z:a`<div class="media-zone">
    ...
    `],i([o()],u.prototype,"type",2),i([o()],u.prototype,"asset",2),i([o({attribute:"asset-type"})],u.prototype,"assetType",2),i([o()],u.prototype,"date",2),i([o({attribute:"start-date"})],u.prototype,"startDate",2),i([o()],u.prototype,"url",2),u=i([d("kd-life-event")],u);var x=class extends s{render(){return a`<span class="timeline"></span><slot class="events"></slot>`}};x.styles=[n`
      :host {
        display: block;
        position: relative;
    ...
    `],i([P({selector:"kd-life-event"})],x.prototype,"lifeEventEls",2),x=i([d("kd-life-events")],x);function G(l,r,e){return l?r(l):e?.(l)}var k=class extends s{constructor(){super(...arguments);this.term="";this.definition="";this.type="tags"}get tags(){return this.definition.trim().length===0?[]:this.definition.split(/,(?![^(]*\))/).map(e=>e.trim())}render(){return a`
      <span role="term"><slot name="term">${this.term}</slot></span>
      <span role="definition"
        ><slot>
          ${G(this.type==="tags",()=>a`<span class="tags">${this.tags.map(e=>a`<kd-tag>${e}</kd-tag> `)}</span>`,()=>this.definition)}</slot
        ></span
      >
    `}};k.styles=[n`
      :host {
    ...
    `],i([o()],k.prototype,"term",2),i([o()],k.prototype,"definition",2),i([o()],k.prototype,"type",2),k=i([d("kd-attribution")],k);var j=class extends s{render(){return a`<slot></slot>`}};j.styles=[n`
      :host {
        display: inline-block;
...
`;function te(l){return`\\${l.toString(16)}`}function ae(l){return`:host([icon='${l}'])::before`}function oe(l,r){return`content: '${te(r)}';`}function J(l,r=ae,e=oe){return N(Object.entries(l).map(([t,c])=>`${r(t,c)} { ${e(t,c)} }`).join(""))}var y=class extends s{};y.styles=[Q,n`
      :host {
    ...
    `],i([M(".button",!0)],w.prototype,"_control",2),i([o({type:String,reflect:!0})],w.prototype,"mode",1),w=i([d("kd-mode-switcher")],w);var q=class extends s{connectedCallback(){super.connectedCallback(),this.role="listitem",this.tabIndex=0}update(r){super.update(r),r.has("accent")&&(this.accent?this.style.setProperty("--kd-ooh-logo-hover-background-color",this.accent):this.style.removeProperty("--kd-ooh-logo-hover-background-color"))}render(){return a`<slot></slot>`}};q.styles=[n`
      :host {
        --kd-ooh-logo-depth: 0;
        --kd-ooh-logo-multi: 1;
    ...
    `],i([o()],q.prototype,"accent",2),q=i([d("kd-ooh-logo")],q);var T=class extends s{connectedCallback(){super.connectedCallback(),this.role="list"}render(){return a`<slot class="canvas"></slot>`}};T.styles=[n`
      :host {
        display: block;
