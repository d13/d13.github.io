...
import { css, unsafeCSS } from 'lit'; // unsafeCSS
import { KdBaseElement } from '../base/base-element';
import { iconBase } from './icon.css';

// convert css selectors in the above component's style property to a literal object with the key being the icon name and the value being the content property
