...
- **Accessibility.** Skip-links at the top of every page. Custom elements declare `aria-hidden` where they are decorative. `<html data-theme="auto">` honours the user's OS preference.
